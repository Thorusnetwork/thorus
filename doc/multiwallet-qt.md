...
Only requiring some minor changes is thorus.cpp.
...
Changes to thorus.cpp
----------------------
thorus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
