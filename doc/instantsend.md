...
This mechanism has been integrated into Bitcore-Node-Thorus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/thoruscoin/insight-api-thorus#web-socket-api](https://github.com/thoruscoin/insight-api-thorus#web-socket-api) 
* API: [https://github.com/thoruscoin/insight-api-thorus#instantsend-transactions](https://github.com/thoruscoin/insight-api-thorus#instantsend-transactions) 
...
By default, the Thorus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Thorus Core daemon:
