Thorus Core staging tree 0.12.1
===============================
...
Thorus Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
[Tags](https://github.com/thoruscoin/thorus/tags) are created to indicate new official,
stable release versions of Thorus Core.
