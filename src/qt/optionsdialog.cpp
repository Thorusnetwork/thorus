    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("THOR-light"), QVariant("light"));
    ui->theme->addItem(QString("THOR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("THOR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("THOR-traditional"), QVariant("trad"));
