    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Thorus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Thorus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  thorus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Thorus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 THOR, 0.1 THOR, 1 THOR and 10 THOR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://thoruscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://thoruscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Thorus Core is shutting down...") + "<br /><br />" +
