    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Thorus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Thorus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thorus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Thorus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Thorus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Thorus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Thorus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Thorus addresses"));
    ...
    openAction->setStatusTip(tr("Open a thorus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Thorus Core help message to get a list with possible Thorus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Thorus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Thorus network", "", count));
}
...
{
    QString strTitle = tr("Thorus Core"); // default title
