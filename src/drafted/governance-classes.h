 ...
 *
 *   // network
 *   CThorusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.thorus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CThorusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ThorusNetwork
// //   -- signature requirements : Key1(User)
// class CThorusNetworkVariable : public CGovernanceObject
// {
// private:
