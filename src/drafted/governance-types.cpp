...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ThorusNetwork") type = ThorusNetwork;
    if(strType == "ThorusNetworkVariable") type = ThorusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ThorusNetwork) s = "ThorusNetwork";
    if(type == ThorusNetworkVariable) s = "ThorusNetworkVariable";
