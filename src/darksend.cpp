...
{
    if(fLiteMode) return; // ignore all Thorus related functionality
...
/*
    ...
    allow endless transaction that would bloat Thorus and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("thorus-privatesend");
