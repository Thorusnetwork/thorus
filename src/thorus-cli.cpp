...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Thorus Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  thorus-cli [options] <command> [params]  " + _("Send command to Thorus Core") + "\n" +
                  "  thorus-cli [options] help                " + _("List commands") + "\n" +
                  "  thorus-cli [options] help <command>      " + _("Get help for a command") + "\n";
